...
public final class CryptoContract {
    ...
    private static final String CURRENT_TIMESTAMP = " DEFAULT CURRENT_TIMESTAMP";
    ...
    public static final String SQL_CREATE_NOTIFICATIONS =
            "CREATE TABLE " + CryptoNotifications.TABLE_NAME + " (" +
                    ...
                    CryptoNotifications.COLUMN_NAME_CREATED_AT + INTEGER_TYPE + CURRENT_TIMESTAMP + COMMA_SEP +
                    CryptoNotifications.COLUMN_NAME_UPDATED_AT + INTEGER_TYPE + INTEGER_TYPE_DEFAULT + COMMA_SEP +
    ...
    public static final class CryptoNotifications implements BaseColumns {
        ...
        public static final String DEFAULT_SORT_ORDER       = CryptoNotifications.TABLE_NAME + "." + CryptoNotifications._ID + " ASC";
        ...
        public static final String[] DEFAULT_PROJECTION = new String[] {
                ...
                CryptoNotifications.COLUMN_NAME_CREATED_AT,
                CryptoNotifications.COLUMN_NAME_UPDATED_AT
        };
